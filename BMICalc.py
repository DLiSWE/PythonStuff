...
class fact:
    def shee(*args):
        try:
            ...
            print("One of your inputs is not a number asshole")
        except ZeroDivisionError:
            print("Stop capping, you don't weigh 0 or your height isn't 0")
        else:
            return askweight
...
class BMI:
    ...
    def vari(weight, height):
        try:
            ...
            print("Values are incompatible, check your input asshat")
        except ZeroDivisionError:
            print("You inputed a 0 idiot")
        else:
            return x
